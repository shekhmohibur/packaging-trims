...
const sustainabilityItems = [
  {
    ...
    description:
      "Extrusion runs tuned to cut granule waste per batch.",
  },
  {
    icon: Recycle,
    title: "Recycling Loop",
    description:
      "Offcut film and carton trim re-enters the material stream.",
  },
  {
    icon: Earth,
    title: "Lower Emissions",
    description:
      "Combined carton + poly lines cut transport between vendors.",
  },
  {
    icon: Droplets,
    title: "Waste Tracking",
    description:
      "Scrap logged per shift to catch process losses early.",
  },
  {
    icon: Zap,
    ...
    <section className="bg-[#0F2D25] py-20 lg:py-28 overflow-hidden">
      <div className="max-w-360 mx-auto px-5 lg:px-8">
        ...
        >
          ...
          <h2 className="mt-6 text-4xl md:text-5xl xl:text-6xl font-black uppercase leading-[1.05] text-[#F5EFE3]">
            Less Plastic Waste,
            More Accountable
            Production.
          </h2>
          ...
          <p className="mt-7 max-w-2xl text-[#B7B9B7] leading-8">
            Sustainability here means less scrap per order,
            granules that get reused,
            and a factory line that tracks its own waste —
            not a slogan on the wall.
          </p>
        </motion.div>
