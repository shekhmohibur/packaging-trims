      ...
      <div className="max-w-360 mx-auto px-6 lg:px-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="mt-6 text-4xl md:text-5xl xl:text-6xl uppercase font-black leading-[1.05] text-[#17352B]">
              Two Materials, One Production Line —
              Cartons And Poly,
              Made Side By Side.
            </h2>
            ...
            <p className="mt-8 text-gray-600 leading-8">
              ...
              plastic-granule-to-film poly manufacturing under one roof,
              built specifically to serve garments, knitwear and woven exporters
              who need both, on the same delivery schedule.
            </p>

            <p className="mt-6 text-gray-600 leading-8">
              Every order is matched to a buyer's compliance sheet —
              size, GSM, ply, thickness, print colour —
              before it reaches the floor,
              so what ships out is what the buyer signed off on.
            </p>
