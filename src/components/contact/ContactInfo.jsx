...
export default function ContactInfo() {
  return (
    <div>
      ...
      <h2 className="mt-6 text-3xl md:text-4xl lg:text-5xl font-black uppercase text-[#17352B] leading-tight">
        {contactData.title}
      </h2>
      ...
      <div className="mt-10">
        {items.map((item) => {
          ...
          return (
            <div
              key={item.title}
              className="flex gap-5 border-b border-[#E7DDCF] py-7"
            >
              <Icon size={22} className="text-[#E56B2D] mt-1" />
              ...
              <div>
                ...
                <p className="mt-2 text-[#4B5B52]">{item.value}</p>
              </div>
            </div>
          );
        })}
